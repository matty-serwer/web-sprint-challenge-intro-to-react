...
React JS is a javascript library that allows us to use interchangable and reusable components. These components are loaded on the users computer such that the user's experience is uninterupted by page reloads, and feels more like a traditional application.

1. Describe component state.
the compnent state is the information saved during a users experience that can change the state of the react application.

1. Describe props.
props are the variables shared between components, for a seemles user experience.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects are things that happen outside of the current function. These are generally network requests. you can sync these side effects, using use effects early in the component, and setting the pertinent information to a variable kept in state.
